    ...
    return (
        <div className='container mx-auto p-4'>
            <div className='flex flex-col lg:flex-row'>
                {/* Filters Section */}
                <div className='lg:w-1/4 lg:bg-white lg:p-2 lg:min-h-[calc(100vh-120px)] lg:overflow-y-scroll'>
                    {/* Sort by */}
                    <div className='p-4 lg:pb-2 lg:border-b lg:border-slate-300'>
...
//     return (
//         <div className='container mx-auto p-4'>
//             <div className='lg:grid lg:grid-cols-[200px,1fr]'>
//                 {/* Filters Section */}
//                 <div className='lg:bg-white lg:p-2 lg:min-h-[calc(100vh-120px)] lg:overflow-y-scroll'>
//                     {/* Sort by */}
//                     <div className='p-4 lg:pb-2 lg:border-b lg:border-slate-300'>
//                         <h3 className='text-base uppercase font-medium text-slate-500'>Sort by</h3>
//                         <form className='text-sm flex flex-col gap-2 py-2'>
