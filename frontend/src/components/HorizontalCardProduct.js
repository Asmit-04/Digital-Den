            ...
            <div className='flex items-center gap-4 md:gap-6 overflow-scroll scrollbar-none transition-all' ref={scrollElement}>
                ...
                {loading ? (
                            ...
                            <div key={index} className='w-full min-w-[280px] md:min-w-[320px] max-w-[280px] md:max-w-[320px] h-36 bg-white rounded-sm shadow flex'>
                                ...
                                <div className='p-4 grid w-full gap-2'>
                                    ...
                                    <div className='flex gap-3 w-full'>
                                        <p className='text-purple-700 font-medium p-1 bg-slate-200 w-full animate-pulse rounded-full'></p>
                    ...
                    data.map((product, index) => {
                        return (
                            <Link key={index} to={"product/" + product?._id} className='w-full min-w-[280px] md:min-w-[340px] max-w-[280px] md:max-w-[340px] h-36 bg-white rounded-sm shadow flex'>
                                ...
                                <div className='p-4 grid'>
                                    ...
                                    <button className='text-sm bg-purple-700 hover:bg-purple-700 text-white px-3 py-0.5 rounded-full' onClick={(e) => handleAddToCart(e, product?._id)}>Add to Cart</button>
                                </div>
                            </Link>
                        )
                    })
