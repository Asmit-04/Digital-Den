  ...
  switch (event.type) {
    case 'checkout.session.completed':
      ...
      const orderDetails = {
        ...
        name: session.customer_details.name,  // Capture customer name
        ...
        shipping_address: session.shipping_details?.address,  // Save shipping address
        billing_address: session.customer_details?.address,  // Save billing address
